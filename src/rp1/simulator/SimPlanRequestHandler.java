...
public class SimPlanRequestHandler implements RsPlanRequestHandler {
   ...
   public void process(RsPlanRequest request) {
      ...
      SimTask task    = new SimPlanTask(client);

      session.verbose("Adding plan request to queue");
